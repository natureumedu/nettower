...
public class GameManager : MonoBehaviour
{
    ...
    private void CreateLevelFromXML()
    {
        ...
        Waypoints = GameObject.FindGameObjectsWithTag("Waypoint")//start
    ...
    IEnumerator NextRound()
    {
        ...
        {//spawn a new enemy
            ...
            Enemies.Add(enemy);
			//add
			GameObject netenemy = Instantiate(EnemyPrefab, Waypoints[9].position, Quaternion.identity) as GameObject;
			NetEnemy netenemyComponent = enemy.GetComponent<NetEnemy>();
			//set speed and enemyKilled handler
			netenemyComponent.Speed += Mathf.Clamp(currentRoundIndex, 1f, 5f);
			netenemyComponent.EnemyKilled += OnEnemyKilled;
