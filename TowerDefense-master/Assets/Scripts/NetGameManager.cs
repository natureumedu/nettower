...
//		NCMBQuery<NCMBObject> query = new NCMBQuery<NCMBObject> ("NetGameManager");
...
//				if( objList.Count == 0 )
//				{
//					NCMBObject obj = new NCMBObject("NetGameManager");
//					obj["Name"]  = name;
//					obj["Enemies"] = 0;
//					obj.SaveAsync();
//					Enemies = 0;
...
//				// ハイスコアが登録済みだったら
//				else {
//					Enemies = System.Convert.ToInt32( objList[0]["Enemies"] ); 
//				}
//			}
//		});
//	}
